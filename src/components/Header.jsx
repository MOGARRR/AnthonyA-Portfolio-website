...
const Header = () => {
  return (
      <div className=" text-3xl flex justify-evenly w-full bg-blue-200 ">
        ...
        <span className="bg-gradient-to-tl from-violet-900 from-20% to-blue-800 to-100% mt-28 content-center rounded-full size-36 mt-5 hover:text-stone-300 cursor-pointer hover:text-4xl hover:size-48">Contacts</span>
