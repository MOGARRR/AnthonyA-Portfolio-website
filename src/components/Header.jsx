...
const Header = () => {
  return (
      <div className=" w-3/5 h-16 flex justify-between items-center bg-gray-100 absolute top-4 rounded-full text-3xl text-stone-50 border border-transparent hover:border-gray-950">
