  ...
  return (
    <div className="m-2">
      ...
      <div className="flex">
        ...
        <div className="mt-4">
          <div className="flex">
          <div className="bg-gray-200 h-2/6 rounded-full m-2 p-3"><a href={github}><i class="fa-brands fa-github fa-2xl"></i></a></div>
          {stack.map((item) => (
            <div className= "bg-gray-200 rounded-full m-2 p-2 text-xl" key={item.id}>{item.name}</div>
          ))}
          </div>
